          ...
          <div className="flex items-center gap-5 flex-col sm:flex-row">
            ...
            <div>
              ...
              <div className="flex items-center gap-[6px]">
                ...
                <span className="text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400] text-headingColor">({totalRating})</span>
              </div>
              <p className="text_para text-[14px] leading-5 md:text-[15px] lg:max-w-[290px] ">{bio}</p>
            </div>
          </div>
