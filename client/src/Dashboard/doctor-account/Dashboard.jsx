      ...
      {!loading && !error && (
        <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
          ...
          <div className="lg:col-span-2">
            {data.isApproved === "pending" && <div className='flex p-4 text-yellow-800 bg-yellow-50 rounded-lg'>
                ...
                <div>
                  ...
                  <h3 className="text-[22px] leading-9 font-bold text-headingColor mt-3">
                    ...
                    <div className="flex items-center gap-[6px]">
                      <span className="flex items-center gap-[6px] text-headingColor text-[14px] leading-5 lg:leading-6 font-semibold ">
                        <img src={starIcon} alt="" /> {data.averageRating}
                      </span>
                      <span className="text-textColor text-[14px] leading-5 lg:leading-6 font-semibold ">
                        ({data.totalRating})
                      </span>
                  </div>
